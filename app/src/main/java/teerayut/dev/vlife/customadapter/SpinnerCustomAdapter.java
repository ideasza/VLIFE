package teerayut.dev.vlife.customadapter;
...
public class SpinnerCustomAdapter extends ArrayAdapter<String> {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        if(position == 0) {
            switch (header) {
                case "province" :
                    textView.setText(activity.getResources().getString(R.string.spinner_select_province));
                    textView.setTextColor(activity.getResources().getColor(R.color.colorAccent));
                    break;
                case "district" :
                    textView.setText(activity.getResources().getString(R.string.spinner_select_district));
                    textView.setTextColor(activity.getResources().getColor(R.color.colorAccent));
                    break;
                case "subdistrict" :
                    textView.setText(activity.getResources().getString(R.string.spinner_select_subdistrict));
                    textView.setTextColor(activity.getResources().getColor(R.color.colorAccent));
                    break;
                default: break;
            }
